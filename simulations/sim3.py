...
def sim3():
    ...
    router2 = SecureEBGP('localhost', 2, 5002)
    ...
    router8 = SecureEBGP('localhost', 8, 5008)
    router9 = SecureEBGP('localhost', 9, 5009)
    ...
    router2.add_neighbor('localhost', 3, 5003)  # r2 -> r3
    router2.add_neighbor('localhost', 4, 5004)  # r2 -> r4
    router2.add_neighbor('localhost', 5, 5005)  # r2 -> r5
    router2.add_as_neighbors([1, 3, 4, 5])
    ...
    router8.add_as_neighbors([5, 6])
    router9.add_neighbor('localhost', 6, 5006)  # r9 -> r6
    router8.add_as_neighbors([6])
    router1.start()
    router2.start()
    router3.start()
    router4.start()
